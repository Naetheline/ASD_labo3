...
${OBJECTDIR}/_ext/1472/counting.o: ../counting.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/counting.o ../counting.cpp

${OBJECTDIR}/_ext/1472/qsort.o: ../qsort.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/qsort.o ../qsort.cpp

${OBJECTDIR}/_ext/1472/select.o: ../select.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/select.o ../select.cpp
